...
#define BUFSIZZ 1024
#define ROOTCERTPEM "./cert/cacert.pem"
#define ROOTKEYPEM "./cert/cakey.pem"
#define SERVERKEYPEM "./cert/server-key.pem"
#define SERVERPEM "./cert/server-cert.pem"
